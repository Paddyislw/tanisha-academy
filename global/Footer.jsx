...
const Footer = () => {
  return (
    <div
      className={`${layout} flex justify-between py-24 sm:grid sm:grid-cols-2 sm:justify-items-center sm: gap-4 bg-primaryDark text-white`}
    >
      <div>
        <div className="flex items-center mb-2">
          {/* <Image src={logo} className="w-14 mb:w-10" alt="Image by Freepik" /> */}
          <p className="mb:text-sm text-center">Tanisha Academy</p>
        </div>
