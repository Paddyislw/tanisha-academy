...
import FAQ from '../../utils/Images/FAQ2.png'
  ...
  return (
    <div className={`mt-24 ${layout}`}>
       <div className="space-y-3">
        ...
        /> */}
        <p className='text-primaryDark text-center font-bold text-xl mb:text-base'>Frequently Asked Questions</p>

        <p
          className={`text-4xl font-semibold sm:text-3xl lg:text-4xl mb:text-2xl text-center ${
...
const Testimonials = ({ inView }) => {
    return (
      <div className="flex flex-col   w-[40%] lg:w-[50%] sm:w-full justify-center  mt-10 space-y-8">
        <FAQTab
